...
- Nya assets ligger i `web/public/icons/myposition.svg`, `mydestination.svg`, `search.svg`, `draghandles.svg`, `close-circle.svg`, `varning.svg`, `help.svg`, `accidents.svg`, `flow.svg`, `live.svg`, `disturbances.svg`, `speed.svg`, `layers.svg`. Location/zoom återanvänder inline-ikonerna i `Map.tsx`.
